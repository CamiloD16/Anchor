...
const Navbar = () => {
  ...
  const handleItemClick = (key) => {
    const actions = {
      ...
      home: () => navigate('/'),
      signIn: () => navigate('/register'),
      createPost: () => navigate('/createpost')
    };
  ...
  return (
    <nav className="bg-white border-gray-200 md:shadow">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        <div onClick={() => handleItemClick("home")} className="flex items-center cursor-pointer">
...
export const Item = (props) => {
  return (
    <a onClick={props.handleClick} className="block py-2 pl-3 pr-4 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:border-0 md:hover:text-cyan-600 md:p-0 md:dark:hover:text-blue-500 dark:hover:bg-gray-700 dark:hover:text-white md:dark:hover:bg-transparent font-bold">{props.itemName}</a>
  )
}
