  ...
  return (
    <>
      ...
      <div className="max-w-screen-xl mx-auto py-16 px-4 md:px-20 lg:px-64 lg:py-24 min-h-screen">
        ...
        <h3 className="mb-2">By: <span className="font-bold capitalize">{publication?.user.username}</span> in <span className="font-bold">{publication?.date.split('T')[0]}</span></h3>
